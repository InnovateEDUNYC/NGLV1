...
{
    public class NglFieldGenerator<TModel, T> : IFieldGenerator<TModel, T>
    {
        /// <summary>
        ...
        public NglFieldGenerator(HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, T>> fieldProperty, IFormTemplate template)
        {
