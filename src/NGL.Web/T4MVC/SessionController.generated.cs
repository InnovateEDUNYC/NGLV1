...
namespace NGL.Web.Controllers
{
    public partial class SessionController
    {
        ...
        public class ActionParamsClass_Delete
        {
            ...
            public readonly string sessionName = "sessionName";
        }
    ...
    public partial class T4MVC_SessionController : NGL.Web.Controllers.SessionController
    {
        ...
        [NonAction]
        partial void DeleteOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int sessionIdentity, string sessionName);

        [NonAction]
        public override System.Web.Mvc.ActionResult Delete(int sessionIdentity, string sessionName)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Delete);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "sessionIdentity", sessionIdentity);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "sessionName", sessionName);
            DeleteOverride(callInfo, sessionIdentity, sessionName);
            return callInfo;
        }
